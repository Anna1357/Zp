...
public class Main {
    public static void main(String[] args) {
        ...
        Employee[] employees = {
                new EmplyeeAndBonus("Иванов", PaymentTypes.JOB_PRICE, 3000, true,false, 201),
                new EmplyeeAndBonus("Сидоров", PaymentTypes.HOURLY, 800, true,false,120),
                new EmplyeeAndBonus("Петров", PaymentTypes.RATE, 5500, true,false,230)};
